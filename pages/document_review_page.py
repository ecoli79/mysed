        ...
        with ui.column().classes('w-full'):
            ...
            with ui.row().classes('w-full mb-4'):
                ...
                ui.button(
                    'Найти',
                    icon='search',
                    on_click=lambda: search_documents_for_review(doc_search_input.value)
                ).classes('bg-blue-500 text-white')
            ...
            with ui.card().classes('p-4 bg-gray-50'):
                ...
                ui.button(
                    ...
                    icon='play_arrow',
                    on_click=lambda: start_document_review(selected_document, assignee_list.value, business_key.value)
...
def start_document_review(selected_document: Dict, assignee_list: str, business_key: str):
    """Запускает процесс ознакомления с использованием Multi-Instance"""
    if not selected_document['doc']:
